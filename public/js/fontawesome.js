window.FontAwesomeKitConfig = { "asyncLoading": { "enabled": false }, "autoA11y": { "enabled": true }, "baseUrl": "https://ka-f.fontawesome.com", "detectConflictsUntil": null, "iconUploads": {}, "license": "free", "method": "css", "minify": { "enabled": true }, "token": "81bf6c1ea2", "v4FontFaceShim": { "enabled": true }, "v4shim": { "enabled": true }, "version": "5.15.1" };
! function(t) { "function" == typeof define && define.amd ? define(t) : t() }((function() {
    ...
    function F(t, e) {
        ...
        var n = [];
        return t.v4shim.enabled && n.push(new S((function(n, r) { E(i(t, { addOn: "-v4-shims", minify: t.minify.enabled }), e).then((function(t) { n(C(t, o({}, e, { id: "fa-v4-shims" }))) })).catch(r) }))), n.push(new S((function(n, r) {
    ...
    try {
        if (window.FontAwesomeKitConfig) {
            var k = window.FontAwesomeKitConfig,
                I = { detectingConflicts: k.detectConflictsUntil && new Date <= new Date(k.detectConflictsUntil), detectionIgnoreAttr: "data-fa-detection-ignore", fetch: window.fetch, token: k.token, XMLHttpRequest: window.XMLHttpRequest, document: document },
                x = document.currentScript ? document.currentScript.parentElement : document.head,
                U = document.currentScript;
            (function() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                return "js" === t.method ? F(t, e) : "css" === t.method ? _(t, e, (function(t) { T(t), L(t) })) : void 0
            })(k, I).then((function(t) {
                t.map((function(t) { return x.appendChild(t) })), I.detectingConflicts && U && T((function() {
                    U.setAttributeNode(document.createAttribute(I.detectionIgnoreAttr));
                    var t = function(t, e) { var n = document.createElement("script"); return e && e.detectionIgnoreAttr && n.setAttributeNode(document.createAttribute(e.detectionIgnoreAttr)), n.src = i(t, { baseFilename: "conflict-detection", fileSuffix: "js", subdir: "js", minify: t.minify.enabled }), n }(k, I);
